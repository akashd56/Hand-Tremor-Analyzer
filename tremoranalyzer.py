...
# Initialize TensorFlow for bonus points
print(f"✅ TensorFlow version: {tf.__version__}")
gpu_available = tf.config.list_physical_devices('GPU')
if gpu_available:
    print("✅ GPU detected and will be used.")
else:
    print("⚠️ GPU not detected. Using CPU for analysis.")
...
def calibrate_baseline(cap, detector, seconds=3):
    ...
    while time.time() - start_time < seconds:
        ...
        cv2.putText(img, "Keep hand visible to set baseline",
...
def main():
    ...
    baseline_noise = calibrate_baseline(cap, detector, seconds=20)
